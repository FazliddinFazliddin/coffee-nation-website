...
export const translations: Record<Language, Record<string, string>> = {
  uz: {
    ...
    'hero.form.email': 'Email manzilingiz',
    'hero.form.phone': 'Telefon raqamingiz',
    'hero.form.service': 'Xizmat turi',
    'hero.form.time': 'Qulay vaqt',
    'hero.form.notes': 'Izoh (ixtiyoriy)',
  ...
  ru: {
    ...
    'hero.form.email': 'Ваш email',
    'hero.form.phone': 'Номер телефона',
    'hero.form.service': 'Тип услуги',
    'hero.form.time': 'Удобное время',
    'hero.form.notes': 'Примечание (необязательно)',
  ...
  en: {
    ...
    'hero.form.service': 'Service Type',
    'hero.form.time': 'Convenient Time',
    'hero.form.notes': 'Notes (optional)',
